...
export const FETCH_CURRENT_ORDER_NOTIFICATIONS_SUCCESS =
  'app/user/FETCH_CURRENT_ORDER_NOTIFICATIONS_SUCCESS';
...
export default function reducer(state = initialState, action = {}) {
  ...
  switch (type) {
    ...
    case FETCH_CURRENT_ORDER_NOTIFICATIONS_SUCCESS:
...
export const fetchCurrentOrderNotificationsSuccess = transactions => ({
  type: FETCH_CURRENT_ORDER_NOTIFICATIONS_SUCCESS,
...
export const fetchCurrentOrderNotifications = () => (dispatch, getState, sdk) => {
  ...
  sdk.transactions
    ...
    .then(response => {
      ...
      dispatch(fetchCurrentOrderNotificationsSuccess(transactions));
    })
...
export const fetchCurrentUserNotifications = () => (dispatch, getState, sdk) => {
  if (transitionsToRequested.length === 0) {
    return;
  }
...
export const fetchCurrentUser = (type, params = null) => (dispatch, getState, sdk) => {
  ...
  return sdk.currentUser
    ...
    .then(response => {
      ...
      if (type) {
        gtmHandler.trackCustomEvent(type, {
    ...
    .then(currentUser => {
      ...
      dispatch(fetchCurrentOrderNotifications());
