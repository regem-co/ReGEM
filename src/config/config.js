...
const siteTitle = 'ReGEM';

// Twitter handle is needed in meta tags (twitter:site). Start it with '@' character
const siteTwitterHandle = '';

//Tiktok
const siteTiktokPage = 'https://www.tiktok.com/@regem_co';

// Instagram page is used in SEO schema (http://schema.org/Organization)
const siteInstagramPage = 'https://www.instagram.com/regem_co';

// Facebook page is used in SEO schema (http://schema.org/Organization)
const siteFacebookPage = '';
...
const analytics = {
  ...
  plausibleDomains: process.env.REACT_APP_PLAUSIBLE_DOMAINS,
