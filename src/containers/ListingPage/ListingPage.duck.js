...
import { TRANSITION_ENQUIRE, TRANSITION_OFFER_MADE_BY_CUSTOMER } from '../../util/transaction';
import {
...
export const sendOffer = (listingId, protectedDataInfo) => (dispatch, getState, sdk) => {
  dispatch(sendEnquiryRequest());
  const bodyParams = {
    transition: TRANSITION_OFFER_MADE_BY_CUSTOMER,
    processAlias: config.transactionProcessAlias,
    params: { listingId, protectedData: protectedDataInfo },
  };
  return sdk.transactions
    .initiate(bodyParams)
    .then(response => {
