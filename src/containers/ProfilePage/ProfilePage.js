...
const mapStateToProps = state => {
  ...
  // Filter out listings where metadata.pocketListing is true
  const listings = allListings.filter(listing => {
    const pocketListing = listing?.attributes?.metadata?.pocketListing;
    return !(pocketListing === true || pocketListing === 'true');
  });
  return {
