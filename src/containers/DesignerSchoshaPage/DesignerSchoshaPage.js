...
import css from './DesignerSchoshaPage.module.css';
import JoinRefindSection from '../../containers/LandingPage/JoinRefindSection/JoinRefindSection';
import ListingsSection from './ListingsScoshaSection/ListingsSection';
...
export const DesignerSchoshaPageComponent = props => {
...
DesignerSchoshaPageComponent.propTypes = {
...
const DesignerSchoshaPage = compose(
  withRouter,
  connect(mapStateToProps),
  injectIntl
)(DesignerSchoshaPageComponent);

export default DesignerSchoshaPage;
