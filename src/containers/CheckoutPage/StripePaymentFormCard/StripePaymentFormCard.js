...
import css from './StripePaymentFormCard.module.css';
 ...
 */
class StripePaymentFormCard extends Component {
  constructor(props) {
    super(props);
...
StripePaymentFormCard.defaultProps = {
  className: null,
  rootClassName: null,
  inProgress: false,
  loadingData: false,
...
StripePaymentFormCard.propTypes = {
  className: string,
...
export default injectIntl(StripePaymentFormCard);
