  ...
  return (
    <div className={classes}>
      <h3 className={css.heading}>
        <FormattedMessage id="ShippingDetails.title2" />
      </h3>
      <FieldTextInput
      ...
      <FieldTextInput
        ...
        label={intl.formatMessage(
          { id: 'ShippingDetails.recipientPhoneNumberLabel2' }
        )}
        placeholder={intl.formatMessage({
      ...
      <div className={css.formRow}>
        <FieldTextInput
          ...
          label={intl.formatMessage({ id: 'ShippingDetails.addressLine1Label2' })}
          placeholder={intl.formatMessage({
      ...
      <div className={css.formRow}>
        ...
        <FieldTextInput
          ...
          label={intl.formatMessage({ id: 'ShippingDetails.postalCodeLabel2' })}
          placeholder={intl.formatMessage({
      ...
      <div className={css.formRow}>
        <FieldSelect
          ...
          disabled={disabled}
          className={css.field}
          label={intl.formatMessage({ id: 'ShippingDetails.stateLabel2' })}
          validate={validators.required(
        ...
        >
          <option disabled value="">
            {intl.formatMessage({ id: 'ShippingDetails.statePlaceholder' })}
          </option>
