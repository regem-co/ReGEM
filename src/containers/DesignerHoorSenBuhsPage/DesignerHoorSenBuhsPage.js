...
import css from './DesignerHoorSenBuhsPage.module.css';
import JoinRefindSection from '../../containers/LandingPage/JoinRefindSection/JoinRefindSection';
import ListingsSection from './ListingsHoorSenBuhsSection/ListingsSection';
...
export const DesignerHoorSenBuhsPageComponent = props => {
...
DesignerHoorSenBuhsPageComponent.propTypes = {
...
const DesignerHoorSenBuhsPage = compose(
  withRouter,
  connect(mapStateToProps),
  injectIntl
)(DesignerHoorSenBuhsPageComponent);

export default DesignerHoorSenBuhsPage;
