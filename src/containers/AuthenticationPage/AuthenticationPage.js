...
import { ensureCurrentUser, isNilOrEmpty } from '../../util/data';
import {
...
import sharingFbImg from '../../assets/refindFacebook-1200x630.jpg';
import sharingTwImg from '../../assets/refindTwitter-600x314.jpg';
...
export class AuthenticationPageComponent extends Component {
  ...
  render() {
    ...
    const handleSubmitSignup = values => {
      const { fname, lname, hasAcceptedNewsletter, ...rest } = values;
      const params = {
        firstName: fname.trim(),
        lastName: lname.trim(),
        hasAcceptedNewsletter: !isNilOrEmpty(hasAcceptedNewsletter),
        ...rest,
      };
      submitSignup(params);
    };
    ...
    const schemaImage = `${config.canonicalRootURL}${sharingFbImg}`;
    ...
    return (
      <Page
        ...
        facebookImages={[{ url: sharingFbImg, width: 1200, height: 630 }]}
        twitterImages={[
          { url: `${config.canonicalRootURL}${sharingTwImg}`, width: 600, height: 314 },
        ]}
        schema={{
