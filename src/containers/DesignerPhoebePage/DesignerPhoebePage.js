...
import css from './DesignerPhoebePage.module.css';
import JoinRefindSection from '../../containers/LandingPage/JoinRefindSection/JoinRefindSection';
import ListingsSection from './ListingsPhoebeSection/ListingsSection';
...
export const DesignerPhoebePageComponent = props => {
...
DesignerPhoebePageComponent.propTypes = {
...
const DesignerPhoebePage = compose(
  withRouter,
  connect(mapStateToProps),
  injectIntl
)(DesignerPhoebePageComponent);

export default DesignerPhoebePage;
