...
import css from './DesignerShyleeRosePage.module.css';
import JoinRefindSection from '../../containers/LandingPage/JoinRefindSection/JoinRefindSection';
import ListingsSection from './ListingsShyleeRoseSection/ListingsSection';
...
export const DesignerShyleeRosePageComponent = props => {
...
DesignerShyleeRosePageComponent.propTypes = {
...
const DesignerShyleeRosePage = compose(
  withRouter,
  connect(mapStateToProps),
  injectIntl
)(DesignerShyleeRosePageComponent);

export default DesignerShyleeRosePage;
