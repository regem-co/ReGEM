...
const LayoutWrapperAccountSettingsSideNavComponent = props => {
  ...
  const tabs = [
    ...
    {
      text: (
        <FormattedMessage id="LayoutWrapperAccountSettingsSideNav.deliverySettingsPageTabTitle" />
      ),
      selected: currentTab === 'DeliverySettingsPage',
      id: 'DeliverySettingsPageTab',
      linkProps: {
