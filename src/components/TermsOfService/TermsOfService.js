...
const TermsOfService = props => {
  ...
  return (
    <div className={classes}>
      ...
      <div>
        <p>
          This website is operated by ReGEM. Throughout the site, the terms “we”, “us” and “our”
          refer to ReGEM. ReGEM offers this website, including all information, tools and services
      ...
      <div>
        <p>
          Any new features or tools which are added to the current marketplace shall also be subject
      ...
      <div>
        <p>2.Online Marketplace Terms</p>
      </div>
      <div>
        <p>
          ...
          your minor dependents to use this site. You may not use our marketplace for any illegal or
      ...
      <div>
        <p>4.Accuracy, Completeness and Timeliness of Information</p>
      </div>
      <div>
        <p>
      ...
      <div>
        <p>5.Modifications to the Service and Prices</p>
      </div>
      <div>
        <p>
      ...
      <div>
        <p>6.Product or Service (if applicable)</p>
      </div>
      <div>
        <p>
          Certain products or services may be available exclusively online through the website.
          These products or services may have limited quantities. We have made every effort to
          display as accurately as possible the colors and images of our products that appear on
          ReGEM. We cannot guarantee that your computer monitor's display of any color will be
          accurate. We reserve the right, but are not obligated, to limit the sales of our products
          or Services to any person, geographic region or jurisdiction. We may exercise this right
          ...
          change at anytime without notice, at the sole discretion of us and the seller. We reserve
          ...
          products, services, information, or other material purchased or obtained by you will meet
          your expectations, or that any errors in the Service will be corrected
        </p>
      </div>
      <div>
        <p>7.Accuracy of Billing and Account Information</p>
      </div>
      <div>
        <p>
      ...
      <div>
        <p>
          ...
          and without any endorsement. We shall have no liability whatsoever arising from or
      ...
      <div>
        <p>
          ...
          products, or services of third-parties. We are not liable for any harm or damages related
          to the purchase or use of goods, services, resources, content, or any other transactions
          made in connection with any third-party websites. Please review carefully the
          third-party's policies and practices and make sure you understand them before you engage
          in any transaction. Complaints, claims, concerns, or questions regarding third-party
          products should be directed to the third-party.
        </p>
      </div>
      <div>
        <p>10.User Comments, Feedback and Other Submissions</p>
      </div>
      <div>
        <p>
          ...
          unlawful, abusive or obscene material, or contain any computer virus or other malware that
          could in any way affect the operation of the Service or any related website. You may not
      ...
      <div>
        <p>
          ...
          on any related website, should be taken to indicate that all information in the Service or
      ...
      <div>
        <p>14.Disclaimer of Warranties; Limited of Liability</p>
      </div>
      <div>
        <p>
          ...
          or conditions of any kind, either express or implied, including all implied warranties or
          conditions of merchantability, merchantable quality, fitness for a particular purpose,
          durability, title, and non-infringement. In no case shall ReGEM, our directors, officers,
          ...
          lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar
      ...
      <div>
        <p>
          You agree to indemnify, defend and hold harmless ReGEM and our parent, subsidiaries,
      ...
      <div>
        <p>
          ...
          using our site. If in our sole judgment you fail, or we suspect that you have failed, to
      ...
      <div>
        <p>
          ...
          be governed by and construed in accordance with the laws of United States.
        </p>
      </div>
      <div>
      ...
      <div>
        <p>Questions about the Terms of Service should be sent to us at service@onrefind.com.</p>
      </div>
    </div>
  );
};
