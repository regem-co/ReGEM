...
import LineItemTaxMaybe, { getCaliforniaTaxAmount } from './LineItemTaxMaybe';
...
import LineItemPaidVia from './LineItemPaidVia';
import LineItemSoldDate from './LineItemSoldDate';
...
export const OrderBreakdownComponent = props => {
  ...
  return (
    <div className={classes}>
      ...
      <LineItemPickupFeeMaybe lineItems={lineItems} intl={intl} userRole={userRole} />
      ...
      <LineItemTotalPrice
        ...
        intl={intl}
        taxAmount={
          isCustomer && shippingState === 'CA' ? getCaliforniaTaxAmount(transaction) : null
        }
      />
      {!isListingPage && isProvider && <LineItemSoldDate transaction={transaction} intl={intl} />}
      {!isListingPage && isProvider && <LineItemPaidVia transaction={transaction} intl={intl} />}
